...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        const result = await Characteristic.getCharacteristic(resultValidate.value.id);
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        const resultValidate = Joi.validate({"id":req.params.id,...req.body}, SchemaCharac);
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        const result = await Characteristic.deleteCharacteristic(resultValidate.value.id);
